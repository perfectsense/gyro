...
@AnnotationProcessorClass(ConditionalNumberForStringValidator.class)
@Repeatable(ConditionalNumberForStrings.class)
public @interface ConditionalNumberForString {
    String selected();
